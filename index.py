...
if ((mode == 'main') or (mode == 'response')):
	...
	echo(
		users,
		f'Зима уже идет к своему завершению, как и наша игра. Да, мы официально заканчиваем «Тайного Санту». Большое спасибо всем участникам! Мы рады, что в этом году участвовало так много потрясающих и креативных людей. Но также мы понимаем, что не все остались довольны... Пожалуйста, оцените нас по ссылке https://forms.gle/NPSZy1Ur78P2Fne16. А подарки все еще можно забирать из 224ГК. Удачи в новом учебном году!',
		exceptlist=[]
	) # Это функция рассылки сообщения всем пользователям, за исключением тех, кто указан в exceptlist
